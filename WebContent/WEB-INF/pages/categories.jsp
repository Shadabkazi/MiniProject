					...
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">Accessories<span>.</span></div>
								<div class="home_text"><p>The most wide range of Accessories.</p></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col">
					...
					<div class="sorting_bar d-flex flex-md-row flex-column align-items-md-center justify-content-md-start">
						<div class="results">Showing <span>${products.size() }</span> products</div>
			...
			<div class="row">
				<div class="col">
					...
					<div class="product_grid">
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="data:image/jpeg;base64,${productImage}" alt=""></div>
							<div class="product_extra product_new"><a href="">New</a></div>
							<div class="product_content">
							<c:forEach var="product" items="${products}" begin="${loop.index }" end="${loop.index }">
								<div class="product_title"><a href="${pageContext.request.contextPath}/product/${product.id}">${product.name }</a></div>
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="<c:url value="/resources/images/product_9.jpg"/>" alt=""></div>
							<div class="product_extra product_sale"><a href="categories.html">Hot</a></div>
							<div class="product_content">
								<div class="product_title"><a href="product.html">Smart Phone</a></div>
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="<c:url value="/resources/images/product_10.jpg"/>" alt=""></div>
							<div class="product_extra product_sale"><a href="categories.html">Hot</a></div>
							<div class="product_content">
								<div class="product_title"><a href="product.html">Smart Phone</a></div>
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="<c:url value="/resources/images/product_11.jpg"/>" alt=""></div>
							<div class="product_extra product_sale"><a href="categories.html">Hot</a></div>
							<div class="product_content">
								<div class="product_title"><a href="product.html">Smart Phone</a></div>
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="<c:url value="/resources/images/product_12.jpg"/>" alt=""></div>
							<div class="product_extra product_sale"><a href="categories.html">Hot</a></div>
							<div class="product_content">
								<div class="product_title"><a href="product.html">Smart Phone</a></div>
