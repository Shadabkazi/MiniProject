...
<div class="super_container">
				...
				<div class="row">
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<div class="logo"><a href="index.html">Pheonix.</a></div>
							<nav class="main_nav">
								<ul>
	...
	<div class="home">
		<div class="home_container">
			<div class="home_background" style="background-image:url(<c:url value="/resources/images/categories.jpg)"/>"></div>
			<div class="home_content_container">
				<div class="container">
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">Mobiles and Smart Phones<span>.</span></div>
								<div class="home_text"><p>The most wide range of Smartphones.</p></div>
							</div>
						</div>
					</div>
				</div>
