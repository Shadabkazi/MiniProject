...
<div class="super_container">
	...
	<div class="home">
		<div class="home_container">
			<div class="home_background" style="background-image:url(<c:url value="/resources/images/cart.jpg)"/>"></div>
	...
	<footer class="footer">
		<div class="footer_background" style="background-image:url(<c:url value="/resources/images/footer.jpg)"/>"></div>
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
						<div class="footer_logo"><a href="#">Pheonix.</a></div>
						<div class="copyright ml-auto mr-auto"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Pheonix Inc.
...
<script src="<c:url value="/resources/styles/styles/bootstrap4/popper.js"/>"></script>
<script src="<c:url value="/resources/styles/styles/bootstrap4/bootstrap.min.js"/>"></script>
<script src="<c:url value="/resources/styles/plugins/greensock/TweenMax.min.js"/>"></script>
<script src="<c:url value="/resources/styles/plugins/greensock/TimelineMax.min.js"/>"></script>
<script src="<c:url value="/resources/styles/plugins/scrollmagic/ScrollMagic.min.js"/>"></script>
<script src="<c:url value="/resources/styles/plugins/greensock/animation.gsap.min.js"/>"></script>
<script src="<c:url value="/resources/styles/plugins/greensock/ScrollToPlugin.min.js"/>"></script>
<script src="<c:url value="/resources/styles/plugins/easing/easing.js"/>"></script>
<script src="<c:url value="/resources/styles/plugins/parallax-js-master/parallax.min.js"/>"></script>
<script src="<c:url value="/resources/styles/js/checkout.js"/>"></script>
</body>
</html>