...
<div class="super_container">
	...
	<div class="home">
		<div class="home_container">
			<div class="home_background" style="background-image:url(<c:url value="/resources/images/contact.jpg)"/>"></div>
				...
				<div class="col-lg-3 offset-xl-1 contact_col">
					<div class="contact_info">
						<div class="contact_info_section">
							...
							<ul>
								<li>Phone: <span>+91 7455 7455 10</span></li>
								<li>Email: <span>customer@pheonix.in</span></li>
							</ul>
						</div>
						<div class="contact_info_section">
							<div class="contact_info_title">Shipping & Returns</div>
							<ul>
								<li>Phone: <span>+91 7455 7455 11</span></li>
								<li>Email: <span>customer@pheonix.in</span></li>
							</ul>
						</div>
						<div class="contact_info_section">
							...
							<ul>
								<li>Phone: <span>+91 7455 7455 12</span></li>
								<li>Email: <span>customer@pheonix.in</span></li>
							</ul>
						</div>
					</div>
...
<script src="<c:url value="/resources/https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyCIwF204lFZg1y4kPSIhKaHEXMLYxxuMhA"/>"></script>
